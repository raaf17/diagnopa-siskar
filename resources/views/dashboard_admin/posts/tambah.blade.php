  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <h4>Tambahkan postingan baru</h4>
        <div>
        ...
        <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" value="{{ auth('admin')->user()->nama }}" readonly>
            </div>
          </div>
          <div class="form-group row mb-4">
          ...
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-12 col-md-7">
              <textarea class="summernote-simple @error('body') is-invalid @enderror" id="body" name="body" >{{ old('body') }}</textarea>
              @error('body')
